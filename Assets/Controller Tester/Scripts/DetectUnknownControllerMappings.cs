...
public class DetectUnknownControllerMappings : MonoBehaviour {
	...
	void Update () {
        ...
        axis1Value.text = Input.GetAxis("Axis 1").ToString();
        ...
        axis5Value.text = Input.GetAxis("Axis 5").ToString();
        axis6Value.text = Input.GetAxis("Axis 6").ToString();
        axis7Value.text = Input.GetAxis("Axis 7").ToString();
        axis8Value.text = Input.GetAxis("Axis 8").ToString();
        axis9Value.text = Input.GetAxis("Axis 9").ToString();
        axis10Value.text = Input.GetAxis("Axis 10").ToString();
        axis11Value.text = Input.GetAxis("Axis 11").ToString();
        axis12Value.text = Input.GetAxis("Axis 12").ToString();
        axis13Value.text = Input.GetAxis("Axis 13").ToString();
        axis14Value.text = Input.GetAxis("Axis 14").ToString();
        axis15Value.text = Input.GetAxis("Axis 15").ToString();
        axis16Value.text = Input.GetAxis("Axis 16").ToString();
        axis17Value.text = Input.GetAxis("Axis 17").ToString();
        axis18Value.text = Input.GetAxis("Axis 18").ToString();
        axis19Value.text = Input.GetAxis("Axis 19").ToString();
        axis20Value.text = Input.GetAxis("Axis 20").ToString();
        axis21Value.text = Input.GetAxis("Axis 21").ToString();
        axis22Value.text = Input.GetAxis("Axis 22").ToString();
        axis23Value.text = Input.GetAxis("Axis 23").ToString();
        axis24Value.text = Input.GetAxis("Axis 24").ToString();
        axis25Value.text = Input.GetAxis("Axis 25").ToString();
        axis26Value.text = Input.GetAxis("Axis 26").ToString();
        axis27Value.text = Input.GetAxis("Axis 27").ToString();
        axis28Value.text = Input.GetAxis("Axis 28").ToString();
/*
